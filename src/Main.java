// Шя Будет трудно.... Тааак я скорее всего много что сделал не так, очень прошу как можно подробнее написать, где я лох.
// ТЗ было очень трудным для моего понимания.
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(manager.epicTaskList.get(3).status); // проверка статуса первого эпика, после смены статуса одного из сабтасков.
        ...
        System.out.println(manager.epicTaskList.get(3).status); // Проверка статуса Первого эпика после выполнения всех подзадач
